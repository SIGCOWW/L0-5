...
//image[jhon][ジョンソン法による操作の例．まず，最も処理時間が短いM1-J3対(3)が選択される．M1は前工程機械であるため，J3は最初に配置される．次に，残った仕事の中で最も処理時間が短いM2-J4対(4)が選択される．M2は後工程機械であるため，J4は最後に配置される．図では省いたが，次に選択されるのはJ2-M1対(6)であり，J2はJ3の後に配置される．よって，この例の解は\{J3,J2,J1,J4\}となる．][scale=1.0]

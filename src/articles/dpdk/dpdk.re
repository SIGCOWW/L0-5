...
そこで今回は、@<b>{DPDK} (Data Plane Development Kit)@<fn>{dprk}をDPDKらしからぬ使い方をしてNICのLEDを制御します。
...
本当はPWMがうまくいかなかった原因を探ったり、リンクLEDのみならずステータスLEDも光らせたかったですね。
...
ただ、この間隔はなんとなくで決めるものではなさそうなので、いい感じでやっておきたかったです。

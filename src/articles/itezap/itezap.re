...
そこで今回は、タンパク質のアミノ酸配列データ (以下、タンパク質配列)を用いて、バラといちごがどれくらい類似しているのかを調査したいと思います。
さらに追加でいくつかの生物種と比較し、バラとどれくらい類似しているのかも調査します。
...
== 類似度の決め方
物と物がどれくらい類似しているかを定量的に計算・解析することは、非常に重要な問題です。
例えば文章Aと文章Bはどのくらい類似しているか、といった類似度計算は検索エンジンなどで使用されています。
...
全体の順位もほとんど変化がありません。
しかし、類似度は5位くらいまで90%以上あり、n=3まではどの生物種も類似しているといえます。
n=4からは順位や類似度も変化しました。

...
そこで今回は、タンパク質のアミノ酸配列データ (以下、タンパク質配列)を用いてバラといちごがどれくらい類似しているのかを調査したいと思います。
さらには追加でいくつかの生物種と比較し、バラとどれくらい類似しているのかも調査します。
...
なお、学名・生物種名は長いので以後はアイドル名の名前で表記します。
